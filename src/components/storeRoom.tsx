...
const StoreRoom = () => {
    ...
    const handleMoreDatails = (slug:numbe) =>{
  ...
  return (
    ...
    <MaxWidthWrapper>
        <SubHeading className="text-center text-gray-600 font-bold uppercase">  Store Room</SubHeading>
        <Paragraph className="text-center py-5 w-full md:w-[500px] flex mx-auto">
            You can choose your favourite store room from here. We can build your dream room at a minimum cost.
        </Paragraph>
        <Carousel>
            <CarouselContent> 
                {storeData?.map((card) => (
                        ...
                        <div className="border p-3 shadow-md mb-2 rounded-lg hover:scale-[102%] transition translate duration-500 h-full flex flex-col"> 
                            ...
                            <div className="flex justify-start w-full mt-auto"> 
                                <button
                                    ...
                                    onClick={()=>handleMoreDatails(card.slug)}
                                >
                                    More Details
                                </button>
                            </div>
