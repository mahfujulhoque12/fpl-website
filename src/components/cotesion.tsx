    ...
    <section className="py-10">
      <MaxWidthWrapper>
        ...
        <div className="grid grid-col-1 gap-6 md:grid-cols-2">
          <div>
          <Image src={quo} width={800} height={500} alt="img" className="rounded-md shadow-md"/>
          </div>
          ...
          <div>
            <form ref={form} onSubmit={handleSubmit}>
              ...
              <div className="w-full mt-8">
                <label className="font-medium text-xs">What Kind Of House You Want</label>
                <input
                  type="text"
                  name="subject"
              ...
              <div className="w-full mt-8">
                <label className="font-medium text-xs">Describe us Brefly</label>
                <textarea
                  name="message"
