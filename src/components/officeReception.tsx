...
const OfficeReception = () => {
    const router = useRouter()

    const handleMoreDetails = (slug:string) =>{
    router.push(`/interiors-faculty/${slug}`)
    }
    const receptionData = cardData.filter(card=> card.id >=31 && card.id <=37 )
  return (
    <section className="py-10 md:py-15">
    <MaxWidthWrapper>
        <SubHeading className="text-center text-gray-600 font-bold uppercase"> Office Reception</SubHeading>
...
export default OfficeReception;