...
import {
  ...
  import cabinet1 from "/public/cabinet/cabinet1.png";
...
const OfficeCabinet = () => {
  return (
    ...
    <MaxWidthWrapper>
        <SubHeading className="text-center text-gray-600 font-bold uppercase">  Office Chair</SubHeading>
        <Paragraph className="text-center py-5 w-full md:w-[500px] flex mx-auto">
            You can choose your favourite Chair for your office. We can sell your favourite  one at  minimum cost.
        </Paragraph>
        <Carousel>
            <CarouselContent> 
                {cardData.map((card) => (
