...
const officeTable = () => {
  return (
    ...
    <MaxWidthWrapper>
        <SubHeading className="text-center text-gray-600 font-bold uppercase">  Office Table</SubHeading>
        <Paragraph className="text-center py-5 w-full md:w-[500px] flex mx-auto">
            You can choose your favourite table for your office. We can sell your favourite  one at  minimum cost.
        </Paragraph>
        <Carousel>
            <CarouselContent> 
                {cardData.map((card) => (
