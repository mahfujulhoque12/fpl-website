            ...
            >
                <div className="absolute inset-0 bg-black bg-opacity-60 flex flex-col justify-center items-center">
                    ...
                    <div className="flex gap-3 items-center mt-4">
                        <Link href="/" className="text-gray-300 font-normal text-base">Home</Link>
                        <MdArrowForwardIos className="text-gray-300" />
                        <Link href="" className="bg-gradient-to-r from-[#20B038] to-[#60D66A] text-transparent bg-clip-text font-normal text-base">
                            Contact Us
                        </Link>
                    </div>
                </div>
