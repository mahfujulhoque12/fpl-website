      ...
      <MaxWidthWrapper>
        ...
        <div className="mt-4 flex-col md:flex-row md:flex md:gap-4">
          <div className="border w-full md:w-8/12 p-4 rounded-lg shadow-md">
            ...
            <p className="mt-2 text-gray-600 text-base">{allInfo.designFeatures}</p>
            <h2 className="mt-2 text-xl uppercase font-bold text-gray-700">
              Sustainability Features
            </h2>
            <p className="mt-2 text-gray-600 text-base">{allInfo.sustainabilityFeatures}</p>
            <h2 className="mt-2 text-xl uppercase font-bold text-gray-700">
              Case Studies
            </h2>
            <p className="mt-2 text-gray-600 text-base">{allInfo.caseStudies}</p>
            <h2 className="mt-2 text-xl uppercase font-bold text-gray-700">
              Floor Plans
            </h2>
            <p className="mt-2 text-gray-600 text-base">{allInfo.floorPlans}</p>
          </div>
          ...
          >
            <div className="relative bg-white p-5 rounded-md">
              <Image
                ...
                width={500}
                height={500}
                className="rounded-md max-w-full h-[400px]"
              />
              <button
                onClick={() => setSelectedImage(null)}
